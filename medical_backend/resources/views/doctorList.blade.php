                    ...
                    <table class="table table-striped projects">
                        ...
                        <tr>
                            ...
                            <td class="project-state">
                                            <span id="statusButton" class="badge badge-success" onclick="sendRequest({{$user['id']}})">
                            ...
                            <td class="project-actions text-right">
                                ...
                                <a class="btn btn-danger btn-sm" href="#" onclick="event.preventDefault(); document.getElementById('delete-form-{{$user['doctor']['doc_id']}}').submit();">
                                    <i class="fas fa-trash"></i>
                                    Delete
                                </a>

                                <form id="delete-form-{{$user['doctor']['doc_id']}}" action="/admin/doctors/{{$user['doctor']['doc_id']}}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
